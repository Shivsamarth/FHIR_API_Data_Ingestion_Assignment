...
Screenshots of the configured Patient Details job is provided as supporting evidence for the notebook tasks, parameters, and notifications.
...
```text
Repository: <ADD_REPOSITORY_NAME_OR_URL>
```

Replace the placeholder above with the repository name or URL before publishing the README.
